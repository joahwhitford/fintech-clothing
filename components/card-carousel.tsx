            ...
            {getVisibleCards().map((card, idx) => (
              ...
              >
                <div className="relative overflow-hidden group h-full">
                  ...
                  <div className="absolute inset-0 bg-[#0d1f3c]/85 text-white p-5 transition-transform duration-300 transform translate-y-full group-hover:translate-y-0 overflow-y-auto flex items-end">
                    <p className="font-logo text-[11px] uppercase tracking-logo text-white/80">{card.content}</p>
                  </div>
                </div>
              </div>
            ))}
